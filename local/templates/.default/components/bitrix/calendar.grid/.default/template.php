...
?>
<?php
 if($row['PROPERTY_NEED_CONFIRM_VALUE'] != 'Да') {

	$row['PROPERTY_EVENT_COLOR_VALUE'].= '36';
 }
?>
...
<label>Начало: <input type="text" required class="calendar-field calendar-field-string"  name="date_start" onclick="BX.calendar({node: this, field: this, bTime: false});"></label>
<label>Окончание: <input type="text" required class="calendar-field calendar-field-string" name="date_end" onclick="BX.calendar({node: this, field: this, bTime: false});"></label>
</div>
</form>
